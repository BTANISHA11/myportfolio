        ...
        >
          ...
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              className="font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <span className="text-theme-green">05. </span> Achievements
            </Link>
          </motion.div>
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              className="  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <span className="text-theme-green">06. </span> Contact
            </Link>
          </motion.div>
          <motion.div
        ...
        <aside className="drawer drawer-hidden" ref={drawerRef}>
          <div className="flex-row text-[16px] ">
            ...
            >
              ...
              <div className="mb-2 mt-1">Experience</div>
            </Link>
            <Link
              to="projects"
              spy={true}
            ...
            <RouterLink
              ...
              className="p-[10px] flex flex-col justify-center  items-center  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <div className="text-theme-green ">05. </div>{" "}
              <div className="mb-2 mt-1">Achievements</div>
            </RouterLink>
            <Link
              to="contact"
              spy={true}
              ...
              className="p-[10px] flex flex-col justify-center  items-center  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <div className="text-theme-green ">06. </div>{" "}
